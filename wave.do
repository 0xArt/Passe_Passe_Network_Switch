...
add wave -noupdate -expand -group core_data_orch -radix hexadecimal -expand /testbench/switch_core/core_data_orchestrator/port_recieve_data
...
WaveRestoreCursors {{Cursor 1} {30605312 ps} 0}
